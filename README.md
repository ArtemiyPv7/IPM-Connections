...
- Кнопки «копировать» у каждого значения; каждое копирование попадает в журнал.
...
- Журнал видит только роль `dev` — отдельная страница «Логи» с поиском-фильтром.
...
| `dev` | только страница «Логи» (журнал действий), без основного интерфейса |
