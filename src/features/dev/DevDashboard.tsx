...
// Сколько последних событий тянем для мини-дашборда.
...
export default function DevDashboard() {
  ...
  return (
    <section className="mb-8 animate-rise">
      <h2 className="font-semibold text-xl text-sky mb-4">
        Мини-дашборд
      </h2>
        ...
        <div className="grid gap-4 xl:grid-cols-3">
          ...
          <div className="glass rounded-xl p-6">
                  ...
                  <div
                    ...
                    style={{
                      height:
                        day.count === 0
                          ? '2px'
                          : `${(day.count / maxLogins) * 100}%`,
                    }}
                  >
                    {/* Всплывающая подсказка над столбиком */}
                    <div className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-1 -translate-x-1/2 whitespace-nowrap rounded-md border border-white/10 bg-black/90 px-2 py-1 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100">
            ...
            <p className="text-xs text-gray mt-3">
              Всего входов за период: {totalLogins}
            </p>
          </div>
                  ...
                  <div key={item.company}>
                    ...
                    <div className="mt-1 h-1.5 rounded bg-white/10 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(item.total / maxCompanyTotal) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div key={item.user}>
                    ...
                    <div className="mt-1 h-1.5 rounded bg-white/10 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(item.copies / maxUserCopies) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
